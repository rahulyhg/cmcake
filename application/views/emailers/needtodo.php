  ...
  <section style="width: 600px; margin:0 auto;">
    <div style="border:0;">
      <div style="text-align:center;">
        <img src="https://storage.googleapis.com/hqemailerimg/3.png" alt="" width="100%;">
      </div>
      <div style="padding: 0px 25px 0px;">
        <div style="padding:10px 0">
          ...
          <p style="margin:0 0 15px 0;">
            Hello there! </p>
            <p style="margin:15px 0px;"> Now that your company has been registered on Happyness Quotient, here’s what you need to do next:
            </p>
      ...
      <div style="padding-bottom:10px">
        <img src="https://storage.googleapis.com/hqemailerimg/15.png" alt="" width="100%;">
      </div>
    </div>
  </section>
</body>
